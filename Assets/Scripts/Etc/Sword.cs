...
public class Sword : MonoBehaviour
{
    ...
    public void UpdateSwordInfo()
    {
        ...
        if (difficult_manager.difficult == "easy")
        {
            switch (sword_index)
            {
                ...
                case 18:
                case 19:
                case 20: sword_price_text.text = "강화 비용 : 0원\n판매 가격 : 0원"; break;
                case 21: sword_price_text.text = "강화 비용 : 핫초코 검 0개\n판매 가격 : 0원"; break;
                case 22: sword_price_text.text = "강화 비용 : 철의 레진 검 0개\n판매 가격 : 0원"; break;
                case 23: sword_price_text.text = "강화 비용 : 까치발 0개\n판매 가격 : 0원"; break;
                case 24: sword_price_text.text = "강화 비용 : 4티어 플랫폼 검 0개\n판매 가격 : 0원"; break;
                case 25: sword_price_text.text = "강화 비용 : 걸죽바 0개\n판매 가격 : 0원"; break;
                case 26: sword_price_text.text = "강화 비용 : 0원\n판매 가격 : 0원"; break;
                case 27: sword_price_text.text = "강화 비용 : 소금 0개\n판매 가격 : 0원"; break;
    ...
    private void Setting()
    {
        ...
        if (difficult_manager.difficult == "easy")
        {
            for (int index = 0; index < success_rates.Length; index++) success_rates[index] = 100;
            for (int index = 0; index < sword_prices.Length; index++) sword_prices[index] = 0;
            for (int index = 0; index < sell_prices.Length; index++) sell_prices[index] = 0;
            for (int index = 0; index < need_preventions.Length; index++) need_preventions[index] = 0;
            for (int index = 0; index < special_sword_prices.Length; index++) special_sword_prices[index] = 0;
